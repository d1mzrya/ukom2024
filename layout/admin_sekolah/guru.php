...
$foreign = "SELECT DISTINCT agama FROM agama";
$optionAgama = mysqli_query($conn, $foreign);
    ...
    <div class="container">
        <div class="row mt-5">
            ...
            <div class="col text-end">
                <a href="../../export/data_guru_generate.php" target="_blank" class="btn btn-sm btn-secondary" role="button">Cetak
                    Laporan</a>
                                    ...
                                    <div class="modal fade" id="editForm<?= $no ?>" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <form action="../../controller/guru_controller.php" method="post">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form action="../../controller/guru_controller.php" method="post">
                                                    <div class="modal-body text-center">
                                                        ...
                                                        <h3 class="text-danger"><?= $row['nama'] ?> - <?= $row['nip'] ?></h3>
                                                    </p>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <input type="hidden" name="id" value="<?= $row['id_guru'] ?>">
